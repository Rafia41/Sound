...
.footer-area {
  ...
  .footer-area .footer-widget-area .subscribe-form {
    ...
    .footer-area .footer-widget-area .subscribe-form button {
      ...
      background: #cc1573;
      background: -webkit-linear-gradient(to right, #cc1515, #63062d);
      background: linear-gradient(to right, #80030d, #d63946);
      position: absolute;
      z-index: 10;
      top: 0;
      right: 0;
      ...
      .footer-area .footer-widget-area .subscribe-form button:hover {
        box-shadow: 0 3px 40px rgb(255, 254, 254); }
  @media only screen and (min-width: 992px) and (max-width: 1199px) {
...
style="background-image: url(img/footer.jpg); background-repeat: no-repeat; background-size:100%;">
<div class="container-fluid">
<div class="row">

<div class="col-6 col-md-12 col-xl-3">
<div class="footer-widget-area mb-100">
<a href="index.php"><img src="img/core-img/navlogo.png"></a>
<p style="text-align: center; " class="copywrite-text"><a href="#">
...
<div class="footer-widget-area mb-100 ml-5">
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7d6cdacb3bf121ea","version":"2023.4.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/musica/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jun 2023 19:49:19 GMT -->
</php>