...
<title>Sound - Feel the Beat</title>
...
<script nonce="8b9ece56-c37a-4c36-ac1a-2b5aa615af4e">
...
<a href="index.php" class="nav-brand"><img src="img/core-img/navlogo.png" alt=""></a>


<div class="classynav p-3">
<ul>
...
<div  class="dropdown-menu bg-success" aria-labelledby="dropdownMenuButton">
    ...
    <a href="indexmusic.php">Audio Songs</a>
    <a href="indexvideo.php">Video Songs</a>
</div>
</li>
</ul>
...
&nbsp; 
<!-- <a href="login/register.php" class="button" 
style="font-weight:bold; font-size: 18px; height:30px;">SIGN UP</a> -->
</div>
</div>
